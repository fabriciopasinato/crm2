...
if(isset($_SESSION["validarIngreso"])){
  if($_SESSION["validarIngreso"]!="ok"){
    echo '<script>window.location ="index.php?pag=panelnewsletter";</script>';
    return;
  }
}else{
...
<div class="bannerPanelClientes" style="background-color:#141414; padding-top:5px; padding-bottom:5px; border-bottom: 6px solid #b21328; border-top: 5px solid #384045;">
  ...
  <center>
    ...
    <label style="color:#fff;">Por area: </label>
...
<div class="container"><br>
  <center><h3>Panel de suscriptores</h3></center><hr class="container">
