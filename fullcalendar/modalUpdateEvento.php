<div class="modal" id="modalUpdateEvento"  tabindex="-1" role="dialog">
  ...
  <form name="formEventoUpdate" id="formEventoUpdate" action="fullcalendar/UpdateEvento.php" class="form-horizontal" method="POST">
    ...
    <div class="form-group">
      <label for="observacion" class="col-sm-12 control-label">Obeservacion</label>
      <div class="col-sm-10">
