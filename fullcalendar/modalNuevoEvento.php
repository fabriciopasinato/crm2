<div class="modal" id="exampleModal"  tabindex="-1" role="dialog">
  ...
  <form name="formEvento" id="formEvento" action="fullcalendar/nuevoEvento.php" class="form-horizontal" method="POST">
		<div class="form-group">
			<label for="evento" class="col-sm-12 control-label">Titulo</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" name="evento" id="evento" placeholder="Titulo..." required/>
			</div>
		</div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="hora" id="hora" placeholder="11 a 13">
      </div>
    </div>

    <input type="hidden" class="form-control" name="id_asesor" id="id_asesor" value="<?php echo $_SESSION["id_asesor"]; ?>">
